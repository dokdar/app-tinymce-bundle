...
use Gajdaw\SimpleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawSimpleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawSimpleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawSimpleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawSimpleMenuBundle:Menu:edit.html.twig")
     */
